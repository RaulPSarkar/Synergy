...
predictionPaths = [Path(__file__).parent / 'predictions' / 'final' / 'DL' / 'dlrun1.csv', Path(__file__).parent / 'predictions' /'final'/'en'/ 'enrun0.csv', Path(__file__).parent / 'predictions' /'final'/'svr'/ 'svrrun0.csv', Path(__file__).parent / 'predictions' /'final'/ 'rf'/ 'rfrun11.csv', Path(__file__).parent / 'predictions' /'final'/'xgboost'/ 'xgboostrun0.csv', Path(__file__).parent / 'predictions' /'final'/'lgbm'/ 'lgbmrun99.csv', Path(__file__).parent / 'predictions' / 'final' / 'ensemble' /  'ensemble.csv', Path(__file__).parent / 'predictions' /'final'/'baseline'/ 'baselinerun0.csv',  Path(__file__).parent / 'predictions' / 'final' / 'DL' / 'dlrun8.csv',  Path(__file__).parent / 'predictions' / 'final' / 'ridge' / 'ridgerun11.csv',  Path(__file__).parent / 'predictions' / 'temp' / 'lgbm0.csv', Path(__file__).parent / 'predictions' / 'temp' / 'dlNew1.csv']
